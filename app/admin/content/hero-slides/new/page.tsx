...
export default function NewHeroSlidePage() {
    ...
    const createSlide = useMutation(api.heroSlides.create);
    ...
    const [location, setLocation] = useState(locationParam || "hero");
            ...
            <header className="bg-card border-b border-border px-8 py-5 flex items-center justify-between shrink-0 z-10">
                <div className="flex flex-col gap-1">
                    <nav className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span className="text-foreground font-medium">New Slide</span>
                    </nav>
                    <h1 className="text-2xl font-bold text-foreground">Create New Slide</h1>
                </div>
